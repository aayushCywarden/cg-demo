...
export function Header() {
  return (
    <header className="bg-white">
      <div className="h-[100px] bg-[#1d3b7d] px-6 flex items-center justify-between overflow-hidden">
      ...
      <div className="h-10 bg-gray-200 border-b border-gray-200 px-6 flex items-center justify-end gap-3">
